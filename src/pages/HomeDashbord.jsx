...
export default function HomeDashboard()  {
  ...
  return (
    ...
    <section className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
        <h1 className="text-center text-3xl font-bold my-5">Home Page</h1>
